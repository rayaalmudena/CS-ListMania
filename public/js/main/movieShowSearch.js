     ...
     success: function(result){
            ...
            if (len==0){     
                ...
                if (window.location.href.indexOf("movie") != -1 || window.location.href.indexOf("show")!= -1) {
                    ...
                    if (result[0]['type']=="movies") {
                        addHTMLSearchMovieShow(result[0]['title'],"movie",result[0]['image']);
                    }else{
                        addHTMLSearchMovieShow(result[0]['title'],"show",result[0]['type'],result[0]['image']);
                    }                    
